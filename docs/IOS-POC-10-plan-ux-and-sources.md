...
- 狀態：**五項都已實作並提交**（10A `202f9f6d`／`64ded548`，X 後來由 10H `e890bdd9` 拿掉；10B `efbd04a4`；10C `6e0f9887`；10D `f4bfc1a5`／`0a2b418c`；10E `5d22d470`）。之後追加的 10G～10Z 也都已提交（最後是 10Z `8a10845f`），結果記在各節。（2026-09-25 更正：原寫「計畫已確認，尚未實作」。）
...
（2026-09-25 更正：IOS-POC-19 `4d703da3` 讓 `adopt` 讀取每個資訊源記住的站台，遠端載入成功後會回到該站台，此缺陷在邏輯上已修，模擬器未另外重現；見 `docs/IOS-POC-19-per-source-site-memory.md`。）
