...
## Current recovery anchor (2026-09-17, after IOS-POC-5K)
...
- Active branch: `ios-poc`, HEAD `3e8a7a84` after IOS-POC-5K, **9 commits ahead of `origin/ios-poc` and not pushed**. Check the actual Git state on resume; do not infer what has been pushed.
