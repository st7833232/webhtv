...
- **Current release: `WebHTV 0.1.17 (18)`, published 2026-09-25 at the user's instruction** (run `36034238374`, tag
  ...
  current source at once, `ee597124`). Its first compile was this release build; unit tests not run.
  **No device result yet.** Record: `docs/IOS-POC-11-sidestore-release.md` 第十八次發布.
- **Previous release: `WebHTV 0.1.16 (17)`, published 2026-09-24** (run `36021136999`, tag
...
- **Previous release: `WebHTV 0.1.14 (15)`, published 2026-09-24 at the user's instruction** (run
  ...
  Record: `docs/IOS-POC-11-sidestore-release.md` 第十五次發布.
- **Previous release: `WebHTV 0.1.13 (14)`, published 2026-09-24** (run
  `35976794989`, tag `ios-v0.1.13-b14` → `8db58a0d`; `source.json` `1635289c`, IPA 24,880,231 bytes,
  SHA-256 `41ab26d0…`, downloaded back and verified): `0.1.12 (13)` plus IOS-POC-19 (each source
  reopens on the site last picked in it) and IOS-POC-21 (another episode starts from its beginning).
  **No device result yet.** Record: `docs/IOS-POC-11-sidestore-release.md` 第十四次發布.
- **Previous release: `WebHTV 0.1.12 (13)`, published 2026-09-24** (run
