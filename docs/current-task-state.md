...
- IOS-POC-26「MPV／原生切換位置不對；MPV 在有廣告的影片上 seek 回到片頭、之後要重啟 App」（2026-09-25 真機回報，另一個 session 並行做 IOS-POC-25）：26-1（交接時 AVPlayer 精確落點）已寫、未編譯；26-2（MPV 廣告 discontinuity 時間軸與核心復原）研究中。見 `docs/IOS-POC-26-engine-switch-position.md`。
