...
## Current recovery anchor (2026-09-17, after IOS-POC-5O)
...
- Active branch: `ios-poc`, HEAD after IOS-POC-5M. Everything through the IOS-POC-5L commits **is pushed** to `origin/ios-poc` (2026-09-17, up to `57b3aa65`); the IOS-POC-5M commits on top of it are local. Check the actual Git state on resume; do not infer what has been pushed.
